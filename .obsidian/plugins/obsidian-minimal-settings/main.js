...
var Q = (e, s) => {
    for (var d in s) C(e, d, { get: s[d], enumerable: !0 });
  },
  X = (e, s, d, m) => {
    if ((s && typeof s == "object") || typeof s == "function")
      for (let o of J(s))
        !K.call(e, o) &&
          ...
          C(e, o, {
            get: () => s[o],
            enumerable: !(m = q(s, o)) || m.enumerable,
          });
    return e;
  };
var Y = (e) => X(C({}, "__esModule", { value: !0 }), e);
var g = (e, s, d) =>
  new Promise((m, o) => {
    var n = (t) => {
        try {
      ...
      r = (t) => (t.done ? m(t.value) : Promise.resolve(t.value).then(n, l));
    r((d = d.apply(e, s)).next());
  });
var ee = {};
Q(ee, { default: () => w });
module.exports = Y(ee);
...
var h = require("obsidian"),
  ...
  c = class extends h.PluginSettingTab {
    constructor(s, d) {
      (super(s, d), (this.plugin = d));
    }
    display() {
      let { containerEl: s } = this;
      s.empty();
      let d = createFragment();
      (d.appendText("For more options, use the "),
        d.appendChild(
          createEl("a", {
            text: "Style Settings",
        ...
        d.appendText(" for details."));
      let m = createFragment();
      (m.createDiv({ cls: "setting-item-name", text: "Color scheme" }),
        m.createDiv({ cls: "setting-item-description" }).appendChild(d),
        new h.SettingGroup(s)
          .setHeading(m)
          .addSetting((t) =>
            t
              ...
              .addDropdown((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.lightScheme = i),
            ...
            t
              ...
              .addDropdown((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.lightStyle = i),
                      this.plugin.saveData(this.plugin.settings),
            ...
            t
              ...
              .addDropdown((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.darkScheme = i),
                      this.plugin.saveData(this.plugin.settings),
            ...
            t
              ...
              .addDropdown((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.darkStyle = i),
                      this.plugin.saveData(this.plugin.settings),
        ...
        new h.SettingGroup(s)
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a.setValue(this.plugin.settings.labeledNav).onChange((i) => {
                  ((this.plugin.settings.labeledNav = i),
                    this.plugin.saveData(this.plugin.settings),
                    this.plugin.refresh());
                }),
              ),
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a.setValue(this.plugin.settings.colorfulFrame).onChange((i) => {
                  ((this.plugin.settings.colorfulFrame = i),
                    this.plugin.saveData(this.plugin.settings),
                    this.plugin.refresh());
                }),
              ),
            ...
            t
              ...
              .addToggle((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.colorfulActiveStates = i),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a
                  .setValue(this.plugin.settings.colorfulHeadings)
                  .onChange((i) => {
                    ((this.plugin.settings.colorfulHeadings = i),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a.setValue(this.plugin.settings.minimalStatus).onChange((i) => {
                  ((this.plugin.settings.minimalStatus = i),
                    this.plugin.saveData(this.plugin.settings),
                    this.plugin.refresh());
                }),
              ),
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a.setValue(this.plugin.settings.trimNames).onChange((i) => {
                  ((this.plugin.settings.trimNames = i),
                    this.plugin.saveData(this.plugin.settings),
                    this.plugin.refresh());
                }),
              ),
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a.setValue(this.plugin.settings.bordersToggle).onChange((i) => {
                  ((this.plugin.settings.bordersToggle = i),
                    this.plugin.saveData(this.plugin.settings),
                    this.plugin.refresh());
                }),
              ),
          ...
          .addSetting((t) =>
            t
              .setName("Focus mode")
              .setDesc(
                "Hide tab bar and status bar, hover to display. Can be toggled via hotkey.",
              )
              .addToggle((a) =>
                a.setValue(this.plugin.settings.focusMode).onChange((i) => {
                  ((this.plugin.settings.focusMode = i),
                    this.plugin.saveData(this.plugin.settings),
                    this.plugin.refresh());
                }),
              ),
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a
                  .setValue(this.plugin.settings.underlineInternal)
                  .onChange((i) => {
                    ((this.plugin.settings.underlineInternal = i),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a
                  .setValue(this.plugin.settings.underlineExternal)
                  .onChange((i) => {
                    ((this.plugin.settings.underlineExternal = i),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a
                  .setValue(this.plugin.settings.fullWidthMedia)
                  .onChange((i) => {
                    ((this.plugin.settings.fullWidthMedia = i),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
          ));
      let n = createFragment();
      (n.appendText("These options can also be defined per file. See "),
        n.appendChild(
          createEl("a", {
            text: "Documentation",
        ...
        n.appendText(" for details."));
      let l = createFragment();
      (l.createDiv({ cls: "setting-item-name", text: "Layout" }),
        l.createDiv({ cls: "setting-item-description" }).appendChild(n),
        new h.SettingGroup(s)
          .setHeading(l)
          .addSetting((t) =>
            t
              .setName("Image grids")
              .setDesc(
                "Turn consecutive images into columns \u2014 to make a new row, add an extra line break between images.",
              )
              .addToggle((a) =>
                a.setValue(this.plugin.settings.imgGrid).onChange((i) => {
                  ((this.plugin.settings.imgGrid = i),
                    this.plugin.saveData(this.plugin.settings),
                    this.plugin.refresh());
                }),
              ),
            ...
            t
              ...
              .addDropdown((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.chartWidth = i),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
            ...
            t
              ...
              .addDropdown((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.iframeWidth = i),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
            ...
            t
              ...
              .addDropdown((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.imgWidth = i),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
            ...
            t
              ...
              .addDropdown((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.mapWidth = i),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
            ...
            t
              ...
              .addDropdown((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.tableWidth = i),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
        ...
        new h.SettingGroup(s)
            ...
            t
              ...
              .addText((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.textNormal = parseFloat(i)),
                      this.plugin.saveData(this.plugin.settings),
            ...
            t
              ...
              .addText((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.textSmall = parseFloat(i)),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
            ...
            t
              ...
              .addText((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.lineHeight = parseFloat(i)),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
            ...
            t
              ...
              .addText((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.lineWidth = parseInt(i.trim())),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
          ...
          .addSetting((t) =>
            t
              ...
              .setDesc(
                "Number of characters per line for wide elements (default 50).",
              )
              .addText((a) =>
                a
                  .setPlaceholder("50")
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.lineWidthWide = parseInt(i.trim())),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
            ...
            t
              ...
              .addText((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.maxWidth = parseInt(i.trim())),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
            ...
            t
              ...
              .addText((a) =>
                a
                  ...
                  .onChange((i) => {
                    ((this.plugin.settings.editorFont = i),
                      this.plugin.saveData(this.plugin.settings),
                      this.plugin.refresh());
                  }),
              ),
...
var u = ["table-100", "table-default-width", "table-wide", "table-max"],
  S = ["iframe-100", "iframe-default-width", "iframe-wide", "iframe-max"],
  b = ["img-100", "img-default-width", "img-wide", "img-max"],
  v = ["map-100", "map-default-width", "map-wide", "map-max"],
  p = ["chart-100", "chart-default-width", "chart-wide", "chart-max"];
function M(e) {
  (e.addCommand({
    ...
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.lightStyle =
          f[(f.indexOf(e.settings.lightStyle) + 1) % f.length]),
          e.saveData(e.settings),
          e.updateLightStyle());
      },
    }),
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.tableWidth =
          u[(u.indexOf(e.settings.tableWidth) + 1) % u.length]),
          e.saveData(e.settings),
          e.refresh());
      },
    }),
    ...
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.chartWidth =
          p[(p.indexOf(e.settings.chartWidth) + 1) % p.length]),
          e.saveData(e.settings),
          e.refresh());
      },
    }),
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.mapWidth =
          v[(v.indexOf(e.settings.mapWidth) + 1) % v.length]),
          e.saveData(e.settings),
          e.refresh());
      },
    }));
...
function P() {
  for (let e of Z) document.body.style.removeProperty(e);
...
function U(e) {
  (L(),
    ...
    document.body.setCssProps({
      ...
      "--font-editor-override": e.editorFont,
    }));
}
function x() {
...
function G(e, s) {
  (e.vault.setConfig("baseFontSize", s), e.updateFontSize());
}
function I(e, s) {
  (document.body.removeClass(
    "theme-light",
    ...
    document.body.addClass("theme-dark", s.darkStyle),
...
function R(e, s) {
  (document.body.removeClass(
    ...
    document.body.addClass("theme-light", s.lightStyle),
    e.vault.getConfig("theme") !== "system" &&
      (e.setTheme("moonstone"), e.vault.setConfig("theme", "moonstone")),
    e.workspace.trigger("css-change"));
}
function $(e) {
  (D(), document.body.addClass(e.darkScheme));
}
function B(e) {
  (y(), document.body.addClass(e.lightScheme));
}
function _(e) {
  if (e.vault.getConfig("theme") === "system")
    ...
    (e.setTheme(d), e.vault.setConfig("theme", d));
  }
  e.workspace.trigger("css-change");
}
function T(e) {
  let s = document.getElementsByClassName("mod-left-split")[0],
    d = document.getElementsByClassName("side-dock-ribbon")[0];
  s &&
  d &&
  document.body.classList.contains("theme-light") &&
  e.lightStyle == "minimal-light-contrast"
    ? (s.addClass("theme-dark"), d.addClass("theme-dark"))
    : s && d && (s.removeClass("theme-dark"), d.removeClass("theme-dark"));
}
var w = class extends j.Plugin {
  onload() {
  ...
  onunload() {
    ...
    let d = document.getElementsByClassName("side-dock-ribbon")[0];
    (d && d.removeClass("theme-dark"), P(), L(), x(), y(), D());
  }
  loadSettings() {
    return g(this, null, function* () {
  ...
  setupListeners() {
    let s = () => {
        let m = this.app.vault.getConfig("baseFontSize");
        this.settings.textNormal = m;
        let o = !1,
          n = !1,
          l = !1;
        (this.app.vault.getConfig("foldHeading")
          ? ((this.settings.folding = !0), (o = !0))
          : (this.settings.folding = !1),
          this.app.vault.getConfig("showLineNumber")
            ? ((this.settings.lineNumbers = !0), (n = !0))
            : (this.settings.lineNumbers = !1),
          this.app.vault.getConfig("readableLineLength")
            ? ((this.settings.readableLineLength = !0), (l = !0))
            : (this.settings.readableLineLength = !1));
        let r = document.body.classList;
        (r.toggle("minimal-folding", o),
          r.toggle("minimal-line-nums", n),
          r.toggle("minimal-readable", l),
          r.toggle("minimal-readable-off", !l),
          this.saveData(this.settings));
      },
      d = () => {
        T(this.settings);
      };
    (this.registerEvent(this.app.vault.on("config-changed", s)),
      this.registerEvent(this.app.workspace.on("css-change", d)),
      s(),
