...
# 🌐 MASTER CONTEXT: Phong (UEH) - SCM Career & AI Product

## 📑 TÓM TẮT ĐIỀU HÀNH (EXECUTIVE SUMMARY)

> **Identity:** Phong, sinh viên UEH
> **Core:** Operations & Planning (Supply Chain)
> **Weapon:** AI/ML/LLM/Multi-Agent Systems
> **Vision 2026:** AI-Enabled Supply Chain Professional + Indie Maker
> **Target:** MT Programs (Unilever, P&G, Shopee) + AI Product Sales (690k VND)
...
- **Username:** `tan_hong_phong`
- **Background:** Sinh viên UEH (Đại học Kinh tế TP.HCM)
...
- **APIs:** Claude API, Gemini API (lưu ý lỗi 429)
- **UI/UX:** Uranus concept (Dark mode, xanh dương/ngọc premium)
...
- **Bảo hành:** 2-3 tháng kỹ thuật, không cam kết vĩnh viễn
...
- ❌ Không định vị AI Engineer thuần
...
## 6. 🎯 SYSTEM INSTRUCTION (CHỈ THỊ CHO AI)

> "Mỗi khi người dùng yêu cầu thực hiện tác vụ liên quan đến Career hoặc AI Product, hãy đối chiếu với file Master Context này.
>
> 1. **Nếu viết CV:** Kiểm tra Impact vận hành? Quá kỹ thuật?
> 2. **Nếu viết Product:** Phù hợp sinh viên/freelancer? Giá 690k?
> 3. **Luôn liên kết:** `[[Hermes]]`, `[[OpenClaw]]`, `[[UEH]]`, `[[Phong]]`
> 4. **Trả lời:** Ngắn gọn, tập trung Next Steps."

---

## 7. 📊 OUTPUT GOALS (CHIẾN LƯỢC ĐẦU RA)

1. **CV:** Tập trung S&OP / Planning (Unilever, P&G, Shopee, FMCG)
2. **Portfolio:** https://tanhongphong.github.io/operation_portfilio/ - Solution-oriented, không phải code repo
3. **Product:** Hermes AI Agent + Template + Docs + Skill pack (690k VND)
...
- [[AI Protocol]] - Logic tư vấn
- [[Decision Ledger]] - Bảng quyết định
- [[Evidence & Portfolio]] - Dữ liệu dự án
- [[Hermes]] - Dự án AI Agent chính
